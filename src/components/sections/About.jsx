...
const About = () => {
  return (
    <div className='w-full pt-8'>
      ...
      <p className='pt-2 text-sm font-inter text-neutralText dark:text-darkText'>Estoy graduado de la carrera Analista de Sistemas y también soy técnico en Administración.
